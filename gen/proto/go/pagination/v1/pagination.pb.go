...
const file_pagination_v1_pagination_proto_rawDesc = "" +
	"\n" +
	"\x1epagination/v1/pagination.proto\x12\rpagination.v1\":\n" +
	"\n" +
	"Pagination\x12\x16\n" +
	"\x06offset\x18\x01 \x01(\rR\x06offset\x12\x14\n" +
	"\x05limit\x18\x02 \x01(\rR\x05limitB\xc4\x01\n" +
	"\x11com.pagination.v1B\x0fPaginationProtoP\x01ZIgithub.com/koneneru/microservices/gen/proto/go/pagination/v1;paginationv1\xa2\x02\x03PXX\xaa\x02\rPagination.V1\xca\x02\rPagination\\V1\xe2\x02\x19Pagination\\V1\\GPBMetadata\xea\x02\x0ePagination::V1b\x06proto3"
